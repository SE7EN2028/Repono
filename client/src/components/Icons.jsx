...
export const Flow = (p) => <Icon {...p}><circle cx="5" cy="6" r="2"/><circle cx="5" cy="18" r="2"/><circle cx="19" cy="12" r="2"/><rect x="10" y="9" width="5" height="6" rx="1"/><path d="M7 6h3M7 18h3M15 12h2"/></Icon>;
